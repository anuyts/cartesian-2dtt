...
\item \oftp{\G}{t}{S} where
  \ofdtp{\Gamma}{S}{\types} means $t$ is an element of $\varprojlim S$.
...
\todoi{What is below, is copied from earlier version and NOT updated.}
\subsection{Hom Types}
\todoi{Note that non-dependent hom elimination is just twisted substitution.}
